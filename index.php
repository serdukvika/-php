...
$str_form_sort = '<div class="sort">
<div class="container">
<h3>Сортировать по:</h3>
<form action="index.php" name="sortForm" method="post">
 <select name="sort" size="1" class="name_film">
 ...
 <input name="gosort" type="submit" value="Подтвердить" class="header__button">
</form>
</div>
</div>';
echo $str_form_sort;
...
$str_form_search = "<div class='search'>
            <div class='container'>
            <h3 class='search_h3'>Поиск:</h3>
            ...
            <input type='text' name='search' class='search_text'>
 			 ...
 			 <input type='submit' name='gosearch' value='Подтвердить' class='header__button'>
 			 <input type='submit' name='clear' value='Сбросить' class='header__button'>
 		     </form>
              </div>
              </div>";
